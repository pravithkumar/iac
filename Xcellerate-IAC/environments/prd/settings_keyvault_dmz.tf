locals {
  configure_kv_dmz_resources = {

    settings = {

      "kv-${var.app_name}-${var.environment}-dmz-${var.location}-001" = {
        azurerm_key_vault_name          = "kv-${var.app_name}-${var.environment}-dmz-${var.location}-001"
