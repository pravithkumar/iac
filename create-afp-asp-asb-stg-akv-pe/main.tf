...
module "azurerm_key_vault" {
  ...
  kv.enabled_for_deployment              = var.kv_enabled_for_deployment
  kv.enabled_for_disk_encryption         = var.kv_enabled_for_disk_encryption
  kv.enabled_for_template_deployment     = var.kv_enabled_for_template_deployment
