locals {
  ...
  logic_app_name               = "la-${local.app_name}-${local.environment}-${local.location_test}-05" 
  app_service_plan_name        = "asp-${local.app_name}-${local.environment}-${local.location_test}-05" 
  ...
  function_app_name       = "fa-${local.app_name}-${local.environment}-${local.location_test}-05"  
  resource_group_name     = "rg-${local.app_name}-${local.environment}-${local.location_test}-05"
