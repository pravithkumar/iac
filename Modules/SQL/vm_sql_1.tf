...
module "sqlaoa_2node_primary_vm_DC10ANS01TFCW" {
  for_each                                           = var.sqlaoa_2node_primary_vm_DC10ANS01TFCW
  ...
  network_interface_ids                              = [
    module.sqlaoa_2node_primary_node_mgmt_nic_DC10ANS01TFCW.nic_id,
    module.sqlaoa_2node_primary_node_db_nic_DC10ANS01TFCW.nic_id,
    module.sqlaoa_2node_primary_node_iscsi_nic_DC10ANS01TFCW.nic_id
  ]
  ...
  availability_set_id                                = module.sqlaoa_2node_sc_avset_DC10ANS01TFCW.availability_set_id
  ...
  cluster_ip                                         = module.sqlaoa_2node_sc_loadbalancer_DC10ANS01TFCW.custer_frontend_ip
  listener_name                                      = each.value.listener_name
  listener_ip                                        = module.sqlaoa_2node_sc_loadbalancer_DC10ANS01TFCW.listener_frontend_ip
  vm_management_ip                                   = module.sqlaoa_2node_primary_node_mgmt_nic_DC10ANS01TFCW.nic_ip
  vm_database_ip                                     = module.sqlaoa_2node_primary_node_db_nic_DC10ANS01TFCW.nic_ip
  ...
  ip_iscsi                                           = module.sqlaoa_2node_primary_node_iscsi_nic_DC10ANS01TFCW.nic_ip
  ansible_bearer_token                               = data.azurerm_key_vault_secret.ansible_bearer_token.value
  trigger_ansible                                    = each.value.trigger_ansible

  depends_on = [module.sqlaoa_2node_sc_loadbalancer_DC10ANS01TFCW]
}
